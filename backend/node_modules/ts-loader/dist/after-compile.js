        ...
        if (associatedModules !== undefined) {
            associatedModules.forEach(module => {
                ...
                if (!moduleHasWebpackErrors(module)) {
                    formattedErrors.forEach(error => (0, loaderUtils_1.addErrorToModule)(module, error));
                }
...
function removeCompilationTSLoaderErrors(compilation, loaderOptions) {
    ...
    // compilation.
    compilation.errors = compilation.errors.filter(error => !isTSLoaderModuleError(error, loaderOptions));
}
function removeModuleTSLoaderError(module, loaderOptions) {
    if (loaderUtils_1.isWebpack5 && module.getWarnings) {
...
function isTSLoaderModuleError(error, loaderOptions) {
    return (error === null || error === void 0 ? void 0 : error.details) === (0, utils_1.tsLoaderSource)(loaderOptions);
}
function moduleHasWebpackErrors(module) {
