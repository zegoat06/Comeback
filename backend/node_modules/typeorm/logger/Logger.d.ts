...
export interface Logger {
     ...
     */
    logQuery(query: string, parameters?: any[] | ObjectLiteral, queryRunner?: QueryRunner): any;
    /**
     * Logs query that is failed.
     */
    logQueryError(error: string | Error, query: string, parameters?: any[] | ObjectLiteral, queryRunner?: QueryRunner): any;
    /**
     * Logs query that is slow.
     */
    logQuerySlow(time: number, query: string, parameters?: any[] | ObjectLiteral, queryRunner?: QueryRunner): any;
    /**
