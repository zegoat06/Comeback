    ...
    computeDiffColumns(subject) {
        ...
        subject.metadata.columns.forEach((column) => {
            ...
            if (subject.databaseEntity) {
                    ...
                    switch (column.type) {
                        case "date":
                            normalizedValue = column.isArray
                                ? normalizedValue.map((date) => DateUtils_1.DateUtils.mixedDateToDateString(date))
                                : DateUtils_1.DateUtils.mixedDateToDateString(normalizedValue);
                        ...
                        case "timetz":
                            normalizedValue = column.isArray
                                ? normalizedValue.map((date) => DateUtils_1.DateUtils.mixedDateToTimeString(date))
                                : DateUtils_1.DateUtils.mixedDateToTimeString(normalizedValue);
                            databaseValue = column.isArray
                        ...
                        case "timestamptz":
                            normalizedValue = column.isArray
                                ? normalizedValue.map((date) => DateUtils_1.DateUtils.mixedDateToUtcDatetimeString(date))
                                : DateUtils_1.DateUtils.mixedDateToUtcDatetimeString(normalizedValue);
                            databaseValue = column.isArray
                        ...
                        case "simple-array":
                            normalizedValue =
                                DateUtils_1.DateUtils.simpleArrayToString(normalizedValue);
                            databaseValue =
                                DateUtils_1.DateUtils.simpleArrayToString(databaseValue);
                            break;
                        case "simple-enum":
                            normalizedValue =
                                DateUtils_1.DateUtils.simpleEnumToString(normalizedValue);
                            databaseValue =
                                DateUtils_1.DateUtils.simpleEnumToString(databaseValue);
                            break;
                        case "simple-json":
                            normalizedValue =
                                DateUtils_1.DateUtils.simpleJsonToString(normalizedValue);
                            databaseValue =
                ...
                else if ((0, Uint8ArrayUtils_1.isUint8Array)(normalizedValue) &&
                    (0, Uint8ArrayUtils_1.isUint8Array)(databaseValue)) {
                    if ((0, Uint8ArrayUtils_1.areUint8ArraysEqual)(normalizedValue, databaseValue)) {
                        return;
                    }
                }
                else {
