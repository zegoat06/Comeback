...
class RawSqlResultsToEntityTransformer {
    ...
    // Constructor
    // -------------------------------------------------------------------------
    constructor(expressionMap, driver, rawRelationIdResults, queryRunner) {
    ...
    group(rawResults, alias) {
        ...
        const primaryKeysSelected = keys.some((key) => key in (rawResults[0] ?? {}));
        for (const rawResult of rawResults) {
            ...
            if (primaryKeysSelected) {
                ...
                id = keys
                    ...
                    if ((0, Uint8ArrayUtils_1.isUint8Array)(keyValue)) {
                        return (0, Uint8ArrayUtils_1.uint8ArrayToHex)(keyValue);
                    }
