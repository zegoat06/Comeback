...
const validate_isolation_level_1 = require("../driver/validate-isolation-level");
...
class DataSource {
    ...
    async initialize() {
        if (this.isInitialized)
            throw new error_1.CannotConnectAlreadyConnectedError();
        // validate isolationLevel before connecting
        (0, validate_isolation_level_1.validateIsolationLevel)(this.driver.supportedIsolationLevels, this.options.isolationLevel);
    ...
    async destroy() {
        if (!this.isInitialized)
            throw new error_1.CannotExecuteNotConnectedError();
