...
export declare class PostgresQueryRunner extends BaseQueryRunner implements QueryRunner {
     ...
     * @param ifExists
     */
    protected dropIndexSql(table: Table | View, indexOrName: TableIndex | string, ifExists?: boolean): Query;
    /**
     ...
     * @param ifExists
     */
    protected dropUniqueConstraintSql(table: Table, uniqueOrName: TableUnique | string, ifExists?: boolean): Query;
    /**
     ...
     * @param ifExists
     */
    protected dropExclusionConstraintSql(table: Table, exclusionOrName: TableExclusion | string, ifExists?: boolean): Query;
    /**
