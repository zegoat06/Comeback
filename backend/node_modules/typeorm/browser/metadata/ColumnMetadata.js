...
const Uint8ArrayUtils_1 = require("../util/Uint8ArrayUtils");
/**
...
class ColumnMetadata {
    ...
    constructor(options) {
        ...
        if (this.isTreeLevel)
            this.type = driver.mappedDataTypes.treeLevel;
        if (this.isCreateDate) {
            if (!this.type)
                this.type = driver.mappedDataTypes.createDate;
        ...
        if (this.isUpdateDate) {
            if (!this.type)
                this.type = driver.mappedDataTypes.updateDate;
        ...
        if (this.isDeleteDate) {
            if (!this.type)
                this.type = driver.mappedDataTypes.deleteDate;
            if (!this.isNullable)
        ...
        if (this.isVersion)
            this.type = driver.mappedDataTypes.version;
    ...
    getEntityValueMap(entity) {
        ...
        if (this.embeddedMetadata) {
            ...
            // then { data: { information: { counters: [this.propertyName]: entity[data][information][counters][this.propertyName] } } }
            // this recursive function helps doing that
            const extractEmbeddedColumnValue = (embeddedMetadataTree, value) => {
                if (value === undefined) {
                    return {};
                }
                ...
                if (embeddedMetadata) {
                    ...
                    if (embeddedMetadata.isArray &&
                        ...
                        return {
                            [embeddedPropertyName]: embeddedPropertyValue.map((element) => extractEmbeddedColumnValue(embeddedMetadataTree.slice(1), element)),
                        };
                    }
                    const submap = extractEmbeddedColumnValue(embeddedMetadataTree.slice(1), embeddedPropertyValue);
        ...
        if (this.embeddedMetadata) {
            ...
            if (embeddedObject) {
                if (this.relationMetadata && this.referencedColumn) {
                    ...
                    if (relatedEntity &&
                        ...
                        !(0, Uint8ArrayUtils_1.isUint8Array)(relatedEntity)) {
                        value =
                        ...
                        !(0, Uint8ArrayUtils_1.isUint8Array)(embeddedObject[this.propertyName]) &&
            ...
            if (this.relationMetadata && this.referencedColumn) {
                ...
                if (relatedEntity &&
                    ...
                    !(0, Uint8ArrayUtils_1.isUint8Array)(entity[this.propertyName]) &&
    ...
    compareEntityValue(entity, valueToCompareWith) {
        ...
        if ((0, Uint8ArrayUtils_1.isUint8Array)(columnValue) && (0, Uint8ArrayUtils_1.isUint8Array)(valueToCompareWith)) {
            return (0, Uint8ArrayUtils_1.areUint8ArraysEqual)(columnValue, valueToCompareWith);
        }
    ...
    build(dataSource) {
        ...
        this.databaseNameWithoutPrefixes = dataSource.namingStrategy.columnName(this.propertyName, this.givenDatabaseName, []);
        return this;
    }
    buildPropertyPath() {
        let path = "";
    ...
    buildDatabaseName(dataSource) {
        ...
        if (dataSource.driver.options.type === "mongodb")
            ...
            propertyNames = [];
        return dataSource.namingStrategy.columnName(this.propertyName, this.givenDatabaseName, propertyNames);
    }
}
