...
class IndexMetadata {
    ...
    constructor(options) {
        ...
        if (options.args?.type &&
            !options.entityMetadata.dataSource.driver.supportedIndexTypes?.includes(options.args.type)) {
            throw new error_1.TypeORMError(`Unsupported index type`);
        }
