...
class EntityMetadata {
    ...
    create(queryRunner, options) {
        ...
        this.lazyRelations.forEach((relation) => this.dataSource.relationLoader.enableLazyLoad(relation, ret, queryRunner));
        return ret;
    }
    /**
     ...
     * @param columns
     */
    static getValueMap(entity, columns) {
    ...
    build() {
        ...
        const entitySkipConstructor = this.dataSource.options.entitySkipConstructor;
        ...
        if (this.tableMetadataArgs.schema) {
            ...
            this.schema = this.dataSource.options.schema;
        }
        this.givenTableName =
            this.tableMetadataArgs.type === "entity-child" &&
                this.parentEntityMetadata
        ...
        this.tablePath = this.dataSource.driver.buildTableName(this.tableName, this.schema, this.database);
        this.orderBy =
