...
class QueryBuilder {
    ...
    createWhereExpression() {
        ...
        if (WRITE_QUERY_TYPES.includes(this.expressionMap.queryType) &&
            ...
            throw new error_1.TypeORMError(`Empty criteria(s) are not allowed for the ${this.expressionMap.queryType} operation. ` +
    ...
    createCteExpression() {
        ...
        const doesDbRequireRecursiveHint = this.dataSource.driver.cteCapabilities.requiresRecursiveHint;
        ...
        const recursiveClause = hasRecursiveCTEs && doesDbRequireRecursiveHint ? "RECURSIVE " : "";
