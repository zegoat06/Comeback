...
export declare class SelectQueryBuilder<Entity extends ObjectLiteral> extends QueryBuilder<Entity> implements WhereExpressionBuilder {
    ...
    protected createJoinTreeRecursively({ children, joinAttribute: joinAttr, }: JoinAttributeTree): string;
    ...
    private computeSelectedColumnExpressions;
    private computeDistinctCountExpression;
