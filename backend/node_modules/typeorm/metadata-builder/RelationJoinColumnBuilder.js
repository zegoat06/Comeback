...
class RelationJoinColumnBuilder {
    ...
    build(joinColumns, relation) {
        ...
        const uniqueConstraint = new UniqueMetadata_1.UniqueMetadata({
            ...
            args: {
                name: this.dataSource.namingStrategy.relationConstraintName(relation.entityMetadata.tableName, foreignKey.columns.map((column) => column.databaseName)),
    ...
    collectColumns(joinColumns, relation, referencedColumns) {
        return referencedColumns.map((referencedColumn) => {
            ...
            const joinColumnName = joinColumnMetadataArg
                ...
                : this.dataSource.namingStrategy.joinColumnName(relation.propertyName, referencedColumn.propertyName);
                    ...
                    args: {
                        ...
                        options: {
                            ...
                            length: !referencedColumn.length &&
                                ...
                                this.dataSource.driver.normalizeType(referencedColumn) !== "uuid" &&
