...
const typeorm_compat_1 = require("./common/typeorm-compat");
const typeorm_utils_1 = require("./common/typeorm.utils");
const data_source_name_registry_1 = require("./data-source-name.registry");
...
let TypeOrmCoreModule = TypeOrmCoreModule_1 = class TypeOrmCoreModule {
    options;
    moduleRef;
    logger = new common_1.Logger('TypeOrmModule');
    constructor(options, moduleRef) {
        this.options = options;
        this.moduleRef = moduleRef;
    }
    static forRoot(options = {}) {
        data_source_name_registry_1.DataSourceNameRegistry.register((0, typeorm_utils_1.getDataSourceName)(options));
        ...
        if (typeorm_compat_1.Connection && dataSourceProvider.provide === typeorm_1.DataSource) {
            providers.push({
                provide: typeorm_compat_1.Connection,
                useExisting: typeorm_1.DataSource,
            });
            exports.push(typeorm_compat_1.Connection);
        }
        return {
    ...
    static forRootAsync(options) {
        if (options.name) {
            data_source_name_registry_1.DataSourceNameRegistry.register(options.name);
        }
        const dataSourceProvider = {
            provide: (0, typeorm_utils_1.getDataSourceToken)(options),
    ...
    async onApplicationShutdown() {
        ...
        try {
            ...
            data_source_name_registry_1.DataSourceNameRegistry.unregister((0, typeorm_utils_1.getDataSourceName)(this.options));
        }
    }
    ...
    static async createDataSourceFactory(options, dataSourceFactory) {
        ...
        const createTypeormDataSource = dataSourceFactory ??
            ((options) => new typeorm_1.DataSource(options));
