...
let TypeOrmModule = TypeOrmModule_1 = class TypeOrmModule {
     ...
     */
    static forRoot(options, name) {
        const resolvedOptions = name !== undefined ? { ...(options ?? {}), name } : options;
        return {
            module: TypeOrmModule_1,
            imports: [typeorm_core_module_1.TypeOrmCoreModule.forRoot(resolvedOptions)],
        };
    }
